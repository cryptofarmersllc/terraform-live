...
docker run -d -v /data/ethereum/beacon:/data -v /data/ethereum/logs:/logs -v /data/ethereum/config:/config \
  ...
  gcr.io/prysmaticlabs/prysm/beacon-chain:v3.2.1 \
  --datadir=/data \
  --rpc-host=0.0.0.0 \
...
docker run -it --rm \
  ...
  gcr.io/prysmaticlabs/prysm/validator:v3.2.1 \
...
docker run -d -v /data/ethereum/wallet:/wallet -v /data/ethereum/validatorDB:/validatorDB -v /data/ethereum/logs:/logs \
  ...
  --name validator-1 gcr.io/prysmaticlabs/prysm/validator:v3.2.1 \
...
-mainnet \
-relay-check -relays https://0xac6e77dfe25ecd6110b8e780608cce0dab71fdd5ebea22a16c0205200f2f8e2e3ad3b71d3499c54ad14d6c21b41a37ae@boost-relay.flashbots.net,https://0xa1559ace749633b997cb3fdacffb890aeebdb0f5a3b6aaa7eeeaf1a38af0a8fe88b9e4b1f61f236d2e64d95733327a62@relay.ultrasound.money
